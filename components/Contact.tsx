...
const Contact = () => {
    ...
    const contactInfo = [
        { icon: <FaEnvelope size={24} />, title: "Email", value: "emmanuelukoh08@gmail.com", href: "mailto:emmanuelukoh08@gmail.com" },
        { icon: <FaWhatsapp size={24} />, title: "WhatsApp", value: "+2348167949054", href: "https://wa.me/+2348167949054" }
    ];
        ...
        <section id="contact" className="relative px-4 lg:px-0 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)' }}>
            ...
            <div className="container-custom relative z-10">
                ...
                >
                    ...
                    >
                        <p className="text-base  text-gray-300 leading-relaxed mb-4 sm:mb-6 px-4 sm:px-0">
                            Have a <span className="gradient-text-secondary font-semibold">project in mind</span> {`or want to collaborate? I'm always excited to work on innovative solutions and scalable systems.`}
                        </p>
                        <p className="text-base  text-gray-400 px-4 sm:px-0">
