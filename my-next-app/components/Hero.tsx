            ...
            <div className="container-custom relative z-10 text-center">
                <div className="w-full max-w-4xl mx-auto flex flex-col items-center relative z-10 px-4">
                    ...
                    >
                        ...
                        >
                            Full Stack & Machine Learning <span className="gradient-text" style={{}}>Developer</span><br />
  ...
  <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
    ...
    performance, security, and growth.
                        ...
                        >
                            ...
                            <motion.a
                                href="/resume"
                                className="btn-secondary inline-flex items-center justify-center gap-3 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-2 rounded-2xl font-semibold w-full sm:w-auto"
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                            >
                        ...
                        <motion.div
                            className="mt-32 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-2xl mx-auto px-4 py-16 sm:px-0"
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
